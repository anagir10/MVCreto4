...
public class VistaRequerimientos extends JFrame {
    ...
    public VistaRequerimientos(){
        ...
        JLabel labelDiseñador = new JLabel("ANA MARIA GIRALDO");
    ...
    public static void requerimiento1() {
        try {
            ...
            String salida = "Salario promedio <400.000\n\nCiudad_Residencia\tSalario_Promedio\n\n";
    ...
    public static void requerimiento2() {
        try {
            ...
            String salida = "Proyectos comprados en Neiva\n\nProyecto\tProveedor\n\n";
    ...
    public static void requerimiento3() {
        try {
            ...
            String salida = "Proyectos 40 a 55/Material\n\nProyecto\tMaterial\n\n";
